...
(function($){
	...
	handler = {
		...
		onClickNode: function (event, node) {
			//yonyouFed:点击时取消所有超链接效果
			$('#'+event.data.treeId+' a').removeClass('focusNode');
			//yonyouFed:添加focusNode样式
